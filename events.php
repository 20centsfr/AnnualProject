          ...
          <div class="grid-container">
            ...
            ?>
              <div class="col-md-6 col-lg-3 text-center">
                ...
                <p class="fs-0">Date et heure : <?php echo $content['dateEvent']; echo $content['heureEvent']; ?></p>
                <p class="fs-0">Duree : <?php echo $content['dureeEvent']; ?> minutes</p>
                <p class="fs-0">Lieu : <?php echo $content['localEvent']; ?></p>
                <p class="fs-0"><?php echo $content['tarifEvent']; ?> € </p>
                <input type="hidden" name="idUser" value="<?php echo $idUser; ?>" >
                <button type="submit" value="<?php echo $content['idEvent']; ?>" name="Event" class="btn btn-success">Rejoindre</button>
              </div>
            <?php } ?>
          </div>
          </div>
