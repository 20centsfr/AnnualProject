      ...
      <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base align-items-center">
          ...
          if(isset($_SESSION['email'])){
            ...
            echo '<li class="nav-item"><a class="nav-link px-3" href="reservations.php">Réservations</a></li>';
            ...
            //echo '<li class="nav-item"><a class="nav-link px-3" href="messagerie.php">Messagerie</a></li>';
            if($admin==1){
              echo '<li class="nav-item"><a class="nav-link px-3" href="admin_dashboard.php">BACK-OFFICE</a></li>';
            } 
