<section class="py-0 bg-1000">
        <div class="container">
          <div class="row py-7">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="assets/img/icons/logo.png" height="70" alt="" /></a>
            <br><br>
        ...
        <section class="py-0 bg-1000">
          <div class="container">
            <div class="row justify-content-md-between justify-content-evenly py-3">
                <p class="fs--1 my-2 fw-bold text-200">&copy; 2023 Together&Stronger</p>
              </div>
          </div>
        </section>
      </section>
